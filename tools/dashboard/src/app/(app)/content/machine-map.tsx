...
//
// Brett: "everything just seems so messy and confusing and not connected", then "all this needs to
// be visible in a beautiful professional visible manner so I don't get lost."
//
// Design posture, per the v3 system and its rejection history: ONE hero (the pipeline rail), not a
...
export function MachineMap({ stats, workspace }: { stats: MachineStats; workspace: string | null }) {
  ...
  // broken". Brett hit exactly that on a client workspace and could not tell which it was. So an
