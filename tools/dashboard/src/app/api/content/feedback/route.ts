 ...
 *
 * Brett reads six scripts in Gmail at 7am. Before this existed his verdict lived only in his head:
 * the good one got recorded, the bad ones were forgotten, and the machine pitched the same rejected
 ...
 * click a single click to correct rather than something Brett has to go hunting for.
 */
