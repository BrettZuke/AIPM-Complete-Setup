...
// 'to_record' is where a script lands when Brett approves it from the daily email. It is
// deliberately separate from 'filming': one means "I said yes to this", the other means "I am
// making it right now", and collapsing them loses the queue he picks tomorrow's shoot from.
export const STAGES = [
