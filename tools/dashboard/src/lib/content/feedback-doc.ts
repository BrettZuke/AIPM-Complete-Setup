 ...
 *
 * That mattered more the moment a second operator arrived: Dan gets his scripts as a weekly email
 * and will rarely open the app, so the email buttons are his ONLY way to teach the machine. Both
 * surfaces now append here.
 */
