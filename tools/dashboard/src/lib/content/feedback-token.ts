 ...
 *
 * Brett reads the scripts in Gmail at 7am and needs to judge each one without logging in, so the
 * verdict has to travel in the URL. A raw card id would let anyone who guessed a uuid write to his
